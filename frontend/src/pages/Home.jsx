  ...
  return (
    <div className="space-y-16">
      <section className="flex min-h-[70vh] items-center">
          <div className="w-full rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800 md:p-12">
          ...
          <div className="mt-6 flex gap-3">
            ...
            <a
              href="#features"
                className="rounded-xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800"
            >
              View Features
            </a>
          </div>
      ...
      <section id="features" className="space-y-6 scroll-mt-24">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Smart Recommendations</h2>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
