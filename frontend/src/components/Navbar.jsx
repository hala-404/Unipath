...
export default function Navbar() {
  ...
  return (
    <aside className="fixed left-0 top-0 flex h-screen w-[280px] flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
      <div className="border-b border-slate-200 px-6 py-6 dark:border-slate-800">
        <div className="text-2xl font-bold text-emerald-500">UniPath</div>
      </div>
      ...
      <div className="mt-auto border-t border-slate-200 px-4 py-4 dark:border-slate-800">
        <Show when="signed-out">
          <div className="space-y-3">
            ...
            <SignUpButton mode="modal">
              <button className="w-full rounded-xl bg-emerald-500 px-4 py-3 text-left text-sm font-medium text-white transition hover:bg-emerald-600 dark:bg-emerald-600 dark:hover:bg-emerald-500">
                Register
              </button>
            </SignUpButton>
          </div>
        ...
        <Show when="signed-in">
          <div className="space-y-3">
            <button
              onClick={toggleTheme}
              className="flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-left text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
            >
